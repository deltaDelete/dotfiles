                    ...
                    child: Widget.Box({
                        children: [
                            PowerButton(
                                ...
                                "~/.config/hypr/gracefully_close.sh && systemctl poweroff",
                                24,
                            ),
                            PowerButton(
                                "system-reboot-symbolic",
                                "~/.config/hypr/gracefully_close.sh && systemctl reboot",
                            ),
                            PowerButton("system-hibernate-symbolic", "hyprctl dispatch dpms off"),
                            PowerButton("system-lock-screen-symbolic", "hyprlock --immediate"),
                            PowerButton(
                                "distributor-logo-windows",
                                "~/.config/hypr/gracefully_windows.sh && systemctl reboot",
                            ),
                        ],
                    }),
                }),
